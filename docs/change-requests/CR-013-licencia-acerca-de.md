...
3. **Autoría (desarrollo):** `Omar Velázquez <contacto@rescatando-el-mezquite.org>` — acreditada en la licencia y en "Acerca de".
...
| Pieza | Detalle |
|---|---|
| `LICENSE` (raíz) | Texto canónico **MIT**. `Copyright (c) 2026 Club Rotario Bosques Aguascalientes` + línea `Autor / Author: Omar Velázquez <contacto@rescatando-el-mezquite.org>`. |
