...
class Copy {
  ...
  // --- Branding (CR-010 #1) ---
  /// Nombre del club anfitrión del piloto, mostrado junto al logo.
  static const orgName = 'Club Rotario Bosques Aguascalientes';

  /// Etiqueta legible de un rol de la consola (sin códigos crudos al usuario).
  static String roleLabel(String wire) =>
      const {
        'administrador': 'Administrador',
        'evaluador': 'Evaluador',
        'analista': 'Analista',
        'admin_consorcio': 'Administración del consorcio',
